...
## Link / Progetti importanti

[Laravel JS Validation Github project](https://github.com/proengsoft/laravel-jsvalidation)

Bisogna aggiungere semplicemente queste linee in fondo alla view, cambiando semplicemente il nome del file con la store/update request e le relative regole per la validazione.
